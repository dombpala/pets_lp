            ...
            '<div class="min-h-screen flex items-center justify-center py-12 px-4">
                <div class="max-w-md w-full">
                    ...
                    <form class="mt-5" action="../state/redirect.php" method="POST">
                        <div>
                            <div>
                                <label for="email" class="font-light text-base text-gray-700">Correo</label>
                                <input name="email" type="email" required class="appearance-none rounded-lg relative block w-full px-3 py-2 border border-gray-800 placeholder-gray-500 text-black-100 focus:outline-none focus:shadow-outline-indigo focus:border-indigo-300 focus:z-10 sm:text-sm sm:leading-5 bg-white" placeholder="Ingrese su correo" />
                            </div>
                            <div class="mt-5">
